...
| [0055](/issues/0055-reconcile-changelog-with-rust-tag-line.md) | DOCS | reconcile `CHANGELOG.md` with the Rust crate tag line — segregate/retire the legacy Python history so the newest entry is the shipped crate version | open | — |
